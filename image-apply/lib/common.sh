...
#   - Driver subfolders (2k22/2k25/w11): confirmed via `7z l` against virtio-win-0.1.285.iso
...
validate_os() {
  case "$1" in
    server2022|server2025|windows11) return 0 ;;
    *) echo "Unknown OS '$1' - expected server2022, server2025, or windows11" >&2; return 1 ;;
  esac
}
